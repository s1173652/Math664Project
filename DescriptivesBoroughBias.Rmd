...
colnames(hate_crimes) <- c("Full.Complaint.ID", "Complaint.Year.Number", "Month.Number", "Record.Create.Date", "Complaint.Precint.Code", "Patrol.Borough.Name", "County", "Law.Code.Category.Description", "Offense.Description", "PD.Code.Description", "Bias.Motive.Description", "Arrest.Date", "Arrest.ID")
```
